...
extern const string trajPath = "/home/rahil/scan_context/traj_sc.txt";
extern const string save_directory = "/home/rahil/scan_context/";
...
extern const float historyKeyframeSearchRadius = 7.0;//20.0; // NOT used in Scan Context-based loop detector / default 7.0; key frame that is within n meters from current pose will be considerd for loop closure
